...
# Vega visualization JSON
vega_force_directed_graph = {
...
# Display the Vega visualization in Streamlit
st.title('Force-Directed Graph of Les Misérables Characters')
st_vega_lite.vega_lite_component(vega_force_directed_graph)
